...
# MAGIC #     "The multi tool agent can solve programming challenges, generating code snippets, debugging issues, and explaining complex coding concepts. Also able to compute mathematical functions and can find latest news about the coatings and automotive industries with similarity search.",
# MAGIC # )
# MAGIC multi_tool_agent_description = (
# MAGIC     "The multi tool agent can find latest news about the coatings and automotive industries with similarity search.",
# MAGIC )
...
# MAGIC %md
# MAGIC ### Test Multi-Tool Agent (vector search tool)
...
input_example = {
    "messages": [
        {
            "role": "user",
            "content": "Run similarity search about Volkswagen",
        }
    ]
}
AGENT.predict(input_example)
